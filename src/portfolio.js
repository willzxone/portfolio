...
const projects = {
  data: [
    ...
    // },
    {
      ...
      description:
        "Assets Allocator is a real-time asset tracking system that uses the Trilateration algorithm to accurately locate assets within a defined space. The system visualizes asset positions on an interactive React dashboard, enabling efficient monitoring and management through a clean, user-friendly interface.",
      languages: [
        {
          name: "ReactJS",
          iconifyClass: "logos-react",
    ...
    },
    {
      ...
      description:
        "Connect with professional healers worldwide for yoga, wellness, and holistic healing. Create profiles, list services, manage bookings, chat securely, and grow your practice—all in one intuitive platform",
      languages: [
        {
          name: "ReactJS",
          iconifyClass: "logos-react",
    ...
    },
    {
      ...
      description:
        "Built a Student Management System using Next.js and PL/SQL with admin, teacher, and student portals. Enabled data management, class enrollment, and attendance tracking across roles.",
      languages: [
        {
          name: "NextJS",
        ...
        {
          name: "PL/SQL",
          iconifyClass: "simple-icons:oracle",
        },
      ],
      links: [],
    },
    {
      ...
      description:
        "Developed a classic Flappy Bird game in x86 assembly language for DOS, featuring user-controlled navigation, obstacle collision detection, score tracking, and a game-over screen. Designed as an educational project to demonstrate low-level game development and the fundamentals of assembly programming",
      languages: [
        {
          name: "x86 Assembly",
